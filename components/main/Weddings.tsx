        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8 mb-8 md:items-start">
            ...
            <div className="col-span-1 md:col-span-6 flex flex-col gap-4 md:gap-6">
              ...
              >
                Zorganizuj z nami niezapomnianą rodzinną uroczystość – zarówno
                tę dużą i wyjątkową, wymagającą szczególnej oprawy, jak i
                kameralne spotkanie pełne ciepła. Hotel Avangarda, oprócz
                doskonałej gastronomii, oferuje kompleksową obsługę przyjęć,
                oddając do dyspozycji Gości komfortowy hotel z basenem,
                kręgielnię, salę zabaw dla dzieci oraz parking. Pod czujnym
                okiem koordynatora, z pomocą doświadczonych kucharzy i
                profesjonalnej obsługi kelnerskiej, dbamy o każdy detal, tworząc
                razem wyjątkowe rodzinne wspomnienia.
              </motion.p>
