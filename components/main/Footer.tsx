              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-col items-center md:items-start space-y-4">
                  ...
                  <p className="text-white/80 text-sm md:text-base max-w-md leading-relaxed text-center md:text-left">
                    Prawdziwa Avangarda w sercu malowniczego Różana. Elegancja,
                    gościnność i bogactwo atrakcji tworzą tu przestrzeń pełną
                    niezapomnianych wrażeń. Idealna na wypoczynek, spotkania
                    biznesowe i rodzinne chwile.
                  </p>
