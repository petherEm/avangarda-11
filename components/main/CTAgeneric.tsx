        ...
        <div className="max-w-7xl mx-auto px-4 space-y-6 py-16">
          ...
          <div className="flex flex-col md:flex-row items-center text-center md:items-center justify-center gap-4 md:gap-8">
            <p className="main-paragraph-light max-w-2xl">
              Odkryj Hotel Avangarda – miejsce, gdzie komfort spotyka się z
              relaksem, a atrakcje czekają na każdym kroku. Niezależnie, czy
              marzysz o chwili wytchnienia, rodzinnej przygodzie, czy
              romantycznym czasie we dwoje – tutaj każdy znajdzie coś dla
              siebie.
            </p>
          </div>
        </div>
