  ...
  const services = [
    {
      icon: Waves,
      title: "Masaże",
      subtitle: "Relaks i regeneracja",
    },
    {
      icon: Heart,
      title: "Zabiegi na twarz",
      subtitle: "Światowe marki kosmetyków",
    },
    {
      icon: SmilePlus,
    ...
    },
    {
      icon: Dumbbell,
      title: "Warsztaty Spa",
      subtitle: "Baw się i ucz pieknie!",
    },
    {
      icon: Clock,
      title: "Vouchery do Spa",
      subtitle: "Wyraź swoją wdzięczność",
    },
    {
      icon: Coffee,
      title: "Biznesowe Day Spa",
      subtitle: "Inny sposób na integrację",
    },
  ];
